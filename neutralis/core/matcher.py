...
from neutralis.core.aliases import ABBREVIATION_MAP
...
# Common abbreviation expansions (pattern, replacement).
# Applied case-insensitively before tokenisation and entity extraction.
# Full dictionary lives in neutralis.core.aliases (666 entries).
_ABBREVIATION_MAP = ABBREVIATION_MAP
